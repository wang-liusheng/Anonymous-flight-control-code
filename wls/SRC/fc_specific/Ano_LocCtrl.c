...
/////////////////////////////////////////////////////////////////		T265	
//			
//			loc_ctrl_1.fb[X] = T265_x*2.5 + 0.03f *vel_fb_d_lpf[X];
//			loc_ctrl_1.fb[Y] =  -T265_y*2 + 0.03f *vel_fb_d_lpf[Y];
//			
//			fb_speed_fix[0] =   T265_x;//OF_DX2FIX;
//			fb_speed_fix[1] = 	 -T265_y;//OF_DY2FIX;			
...
/////////////////////////////////////////////////////////////////////////////////////////////////////////	
	//仅有激光雷达
				...
				// 	if(sens_hd_check.of_ok)
				// 	{
				// 		loc_ctrl_1.fb[X] = loc.lidar_pitch_err*0.8 + 0.03f *vel_fb_d_lpf[X];
				// 		loc_ctrl_1.fb[Y] = loc.lidar_roll_err *0.8+ 0.03f *vel_fb_d_lpf[Y];
						
				// 		fb_speed_fix[0] = loc.lidar_pitch_err*0.8;//OF_DX2FIX;
				// 		fb_speed_fix[1] = loc.lidar_roll_err*0.8;//OF_DY2FIX;
				// 	}
				// 	else//sens_hd_check.of_df_ok
				// 	{
				// 		loc_ctrl_1.fb[X] = of_rdf.gnd_vel_est_h[X] + 0.03f *vel_fb_d_lpf[X];
...
void lidar(u8 dT_ms)
{
	loc.lidar_pitch_exp = 0;
	loc.lidar_roll_exp = 0;

//	loc.lidar_pitch_fb = xxx;
//	loc.lidar_roll_fb = yyy;

	loc.lidar_pitch_err = loc.lidar_pitch_fb - loc.lidar_pitch_exp;
	loc.lidar_roll_err = loc.lidar_roll_fb - loc.lidar_roll_exp;
...
//			{
//			Program_Ctrl_User_Set_HXYcmps( 0.4*T265.pitch_err  ,  0.4*T265.roll_err );
//			}
//			else
//			{
