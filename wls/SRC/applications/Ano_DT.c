...
//	dt.txSet_u2[CSID_X20].fre_ms = 0;  //外部触发
	...
	//ATT_QUA
	dt.txSet_u2[CSID_X04].fre_ms = 20;//
	//height
...
extern u16 	bar_flag;
extern u16 turnstile_flag_right;
extern u16 turnstile_flag_left;
extern u16 pole_flag;
extern float artificial_yaw;
extern s16 T265_x,T265_y,T265_z;
...
//			CycleSendData[(*_cnt)++] = BYTE1(temp_data);	
		...
		case 0x41:
		{
//									temp_data = (s16)(opmv.user.data0);
//									CycleSendData[(*_cnt)++] = BYTE0(temp_data);
//									CycleSendData[(*_cnt)++] = BYTE1(temp_data);				
//			/////////////////////////////////////////////////////////1
//									temp_data = (s16)(opmv.user.data1);
//									CycleSendData[(*_cnt)++] = BYTE0(temp_data);
//									CycleSendData[(*_cnt)++] = BYTE1(temp_data);
			///////////////////////////////////////////////////////////激光雷达
//															temp_data = (s16)(xxx);
...
//										CycleSendData[(*_cnt)++] = BYTE1(temp_data);	
			///////////////////////////////////////////////////////
									...
									temp_data = (s16)(T265_x*2.5);
									CycleSendData[(*_cnt)++] = BYTE0(temp_data);
									CycleSendData[(*_cnt)++] = BYTE1(temp_data);
			
			//////////////////////////////////////////////////////////2
			
									temp_data = (s16)(T265_y*2);
									CycleSendData[(*_cnt)++] = BYTE0(temp_data);
									CycleSendData[(*_cnt)++] = BYTE1(temp_data);
									
			//////////////////////////////////////////////////////////3
			
									temp_data = (s16)(ano_of.of2_dx_fix);
									CycleSendData[(*_cnt)++] = BYTE0(temp_data);
									CycleSendData[(*_cnt)++] = BYTE1(temp_data);
									
			///////////////////////////////////////////////////////////4
			
									temp_data = (s16)( ano_of.of2_dy_fix );
									CycleSendData[(*_cnt)++] = BYTE0(temp_data);
									CycleSendData[(*_cnt)++] = BYTE1(temp_data);	
...
/////////////////////////////////////////////////////////////////////5	
												...
												temp_data = (s16)(T265_lz);
										CycleSendData[(*_cnt)++] = BYTE0(temp_data);
										CycleSendData[(*_cnt)++] = BYTE1(temp_data);
												temp_data = (s16)(T265_lx);
										CycleSendData[(*_cnt)++] = BYTE0(temp_data);
										CycleSendData[(*_cnt)++] = BYTE1(temp_data);
												temp_data = (s16)(T265_ly);
										CycleSendData[(*_cnt)++] = BYTE0(temp_data);
										CycleSendData[(*_cnt)++] = BYTE1(temp_data);
...
///////////////////////////////////////////////////////////////////	6	
//									temp_data = (s16)(opmv.cb.pos_y );
//									CycleSendData[(*_cnt)++] = BYTE0(temp_data);
//									CycleSendData[(*_cnt)++] = BYTE1(temp_data);
/////////////////////////////////////////////////////////////////////7
//			
//												temp_data =flag.flight_mode2;//artificial_yaw;
//									CycleSendData[(*_cnt)++] = BYTE0(temp_data);
//									CycleSendData[(*_cnt)++] = BYTE1(temp_data);
