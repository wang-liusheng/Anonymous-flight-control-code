...
//{
//	u8 res= 12;
//	Gyro->X_data = sensor.Gyro_Original[X];
//	Gyro->Z_data = sensor.Gyro_Original[Y];
//	Gyro->Z_data = sensor.Gyro_Original[Z];
//	ggx=Gyro->X_data;
...
//	Acce->X_data = sensor.Acc_Original[X];
//	Acce->X_data = sensor.Acc_Original[Y];
//	Acce->Z_data = sensor.Acc_Original[Z];
//	accx=Acce->X_data;	
//    return res;
//}
